...
public class ProductsClass {
	...
	/*		String n = driver
					.findElement(By.xpath(
							"html/body/div[1]/div[2]/div/div/div[2]/product-search-comp/div[1]/div/div[1]/div[5]/p"))
					.getText();// result
			System.out.println(n);
			String str = n.replaceAll("\\D+", "");
			System.out.println(str);
			int k = Integer.parseInt(str.trim());
			int i;
			// k-1
			for (i = 1; i <= 1; i++) {
				String view = "html/body/div[1]/div[2]/div/div/div[2]/product-search-comp/div[1]/div/div[1]/div[5]/div/div/div["
						+ i + "]/div[1]/div[1]/div/div/i";
				if (i == 5) {
					WebElement ele = driver.findElement(By.xpath(
							"html/body/div[1]/div[2]/div/div/div[2]/product-search-comp/div[1]/div/div[1]/div[5]/div"));
				...
				driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
				Thread.sleep(8000);
				driver.findElement(By.xpath("//*[@id='myModalDetails']/div/div/div[1]/button")).click();// view close
																										// button
			}*/
		} catch (Exception e) {
			e.printStackTrace();
