...
/*Author :Pooja ps
created date :6-6-18 version:Ecplise Oxygen,Selenium -3.11.0,Testng-6.13.1,Maven-3.7.0
Target - To verify all sites are up
*/

public class AllStoresareUPEnglishClass {
	...
	public void failTest() throws InterruptedException {
		...
		Thread.sleep(8000);
		String EnglishMenu = AllStoresareUPEnglishClass.verifyEnglish(driver);
	...
	@Test
	public static String verifyEnglish(WebDriver driver) {
		...
		try {
			...
			driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
			Thread.sleep(5000);
			driver.findElement(By.xpath("//*[@id='maincontent']/div[3]/div[1]/div/div[3]/div[1]/div[2]/a/img")).click();
			Thread.sleep(3000);
			driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
			driver.findElement(By.xpath("html/body/div[3]/div[1]/div/ul/li[1]/a")).click();
			Thread.sleep(3000);
			driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
			System.out.println("Verified all sites are up for uae english");
		...
		try {
			...
			String country2 = driver.findElement(By.xpath("//*[@id='ui-id-1']/li[2]/a")).getText();
			driver.findElement(By.xpath("//*[@id='ui-id-1']/li[2]/a")).click();
			Thread.sleep(5000);
			driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
			driver.findElement(By.xpath("//*[@id='maincontent']/div[3]/div[1]/div/div[3]/div/div[1]/a/img")).click();
			Thread.sleep(3000);
			driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
			driver.findElement(By.xpath("html/body/div[3]/div[1]/div/ul/li[1]/a")).click();
			Thread.sleep(3000);
			driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
			System.out.println("Verified all sites are up for" + " " + country2 + " " + "English");
		...
		try {
			...
			driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
			driver.findElement(By.xpath("//*[@id='ctv-website-switcher-trigger']/span")).click();
			String country3 = driver.findElement(By.xpath("//*[@id='ui-id-1']/li[3]/a")).getText();
			...
			Thread.sleep(2000);
			driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
			System.out.println("Verified all sites are up for" + " " + country3 + " " + "English");
	...
	public void getResult(ITestResult result) throws Exception {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			String screenshotPath = AllStoresareUPEnglishClass.getScreenhot(driver, result.getName());
