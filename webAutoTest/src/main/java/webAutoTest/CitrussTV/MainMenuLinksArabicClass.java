...
/*Author :Pooja ps
created date :7-6-18 version:Ecplise Oxygen,Selenium -3.11.0,Testng-6.13.1,Maven-3.7.0
...
public class MainMenuLinksArabicClass {
	...
	public void failTest() throws InterruptedException {
		...
		String EnglishMenu = MainMenuLinksArabicClass.arabiclinks(driver);
	...
	@Test
	public static String arabiclinks(WebDriver driver) throws InterruptedException {
		try {
			...
			driver.findElement(By.xpath(
					...
					.click();
			System.out.println("Verified All Main Menu Links Are Working For Arabic");
		} catch (Exception e) {
	...
	public void getResult(ITestResult result) throws Exception {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			String screenshotPath = MainMenuLinksArabicClass.getScreenhot(driver, result.getName());
